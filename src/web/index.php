 ...
 */
$countPages = countPages($airports);    // total pages for this filter
...
<main role="main" class="container">
    ...
    <table class="table">
        ...
        <tr>
            <td><?= $airport['name'] ?></td>
            <td><?= $airport['code'] ?></td>
            <td><a href="<?= generateURL('state', $airport['state'], true) ?>"><?= $airport['state'] ?></a></td>
            <td><?= $airport['city'] ?></td>
    ...
    <nav aria-label="Navigation">
        <ul class="pagination justify-content-center">
            <?php for ($curPage = 1; $curPage<=$countPages; $curPage++) { ?>
                <li class="page-item<?php if($curPage==getCurrentPage()) echo(' active');?>"><a class="page-link" href="<?= generateURL('page', $curPage) ?>"><?=$curPage?></a></li>
            <?php } ?>
        </ul>
    </nav>
